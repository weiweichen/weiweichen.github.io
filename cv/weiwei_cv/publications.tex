...
{\textbf{\large Books}}
\vspace{-2mm}
\begin{enumerate}[\textbf{B\arabic{enumi}.}]
...
{\textbf{\large Patent}}
\vspace{-2mm}
\begin{enumerate}[\textbf{PT\arabic{enumi}.}]
\item Iteration Synchronization Construct for Parallel Pipelines (filed), US 15/191,266
\end{enumerate}

%\vspace{5mm}
%{\textbf{\large Number of citations}}
%\begin{itemize}
%\item
%{\bf Google Scholar:  193} (\href{http://scholar.google.com/citations?user=pC1k0McAAAAJ\&hl=en}{http://scholar.google.com/citations?user=pC1k0McAAAAJ\&hl=en})
%\end{itemize}
